...
- Design: `specs/features/MEM/claude-mem/design.md`
- Plan: `specs/features/MEM/claude-mem/plan.md` (10 incremental steps)
- Research: `specs/features/MEM/claude-mem/research/` (5 files)
