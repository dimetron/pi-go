...
A shell-based E2E test that runs `pi --model minimax-m3:cloud` against a real Ollama backend. The agent explores the
pi-go codebase and generates a PI.md project overview. Success is verified by:
