...
- Design: `specs/features/COD/002-research-coding-agents-session-log-optimizations/design.md`
- Outline: `specs/features/COD/002-research-coding-agents-session-log-optimizations/outline.md`
- Plan: `specs/features/COD/002-research-coding-agents-session-log-optimizations/plan.md`
- Requirements: `specs/features/COD/002-research-coding-agents-session-log-optimizations/requirements.md`
- Research:
  - `specs/features/COD/002-research-coding-agents-session-log-optimizations/research/codebase-exploration.md`
  - `specs/features/COD/002-research-coding-agents-session-log-optimizations/research/session-and-recovery.md`
  - `specs/features/COD/002-research-coding-agents-session-log-optimizations/research/01-json-validation.md`
  - `specs/features/COD/002-research-coding-agents-session-log-optimizations/research/02-old-string-not-found.md`
  - `specs/features/COD/002-research-coding-agents-session-log-optimizations/research/03-path-escapes-security.md`
  - `specs/features/COD/002-research-coding-agents-session-log-optimizations/research/04-file-not-found-retry.md`
  - `specs/features/COD/002-research-coding-agents-session-log-optimizations/research/05-test-panics.md`
  - `specs/features/COD/002-research-coding-agents-session-log-optimizations/research/06-duplicate-file-reads.md`
