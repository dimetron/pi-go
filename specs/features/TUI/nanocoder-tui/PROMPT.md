...
Full specs at `specs/features/TUI/nanocoder-tui/` — design.md for architecture details, plan.md for 11-step implementation order, research/ for nanocoder analysis and Bubble Tea patterns.
