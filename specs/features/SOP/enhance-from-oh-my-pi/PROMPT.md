...
- Design: `specs/features/SOP/enhance-from-oh-my-pi/design.md`
- Plan: `specs/features/SOP/enhance-from-oh-my-pi/plan.md` (14 steps, follow in order)
- Requirements: `specs/features/SOP/enhance-from-oh-my-pi/requirements.md`
- Research: `specs/features/SOP/enhance-from-oh-my-pi/research/gap-analysis.md`
