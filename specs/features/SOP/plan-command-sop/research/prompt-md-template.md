...
1. `specs/features/SOP/enhance-from-oh-my-pi/PROMPT.md` — large multi-feature spec (59 lines)
2. `specs/features/TST/simple-ollama-test/PROMPT.md` — focused single-task spec
...
## Reference
- Design: `specs/features/<task_name>/design.md`
- Plan: `specs/features/<task_name>/plan.md` (<N steps>)
- Requirements: `specs/features/<task_name>/requirements.md`
- Research: `specs/features/<task_name>/research/`
