...
- Design: `specs/features/SOP/plan-command-sop/design.md` (architecture, components, interfaces, error handling)
- Plan: `specs/features/SOP/plan-command-sop/plan.md` (9 steps, follow in order)
- Requirements: `specs/features/SOP/plan-command-sop/requirements.md` (15 Q&A decisions)
- Research: `specs/features/SOP/plan-command-sop/research/` (TUI architecture, subagent system, ralph-orchestrator, PROMPT.md template)
