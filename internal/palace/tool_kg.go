...
func newPalaceKGAddTool(p *Palace) (tool.Tool, error) {
	...
	}, func(ctx tool.Context, input KGAddToolInput) (KGAddToolOutput, error) {
...
func newPalaceKGQueryTool(p *Palace) (tool.Tool, error) {
	...
	}, func(ctx tool.Context, input KGQueryToolInput) (KGQueryToolOutput, error) {
...
func newPalaceKGInvalidateTool(p *Palace) (tool.Tool, error) {
	...
	}, func(ctx tool.Context, input KGInvalidateToolInput) (KGInvalidateToolOutput, error) {
...
func newPalaceKGTimelineTool(p *Palace) (tool.Tool, error) {
	...
	}, func(ctx tool.Context, input KGTimelineToolInput) (KGTimelineToolOutput, error) {
