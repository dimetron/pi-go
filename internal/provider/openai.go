...
// It uses AZURE_OPENAI_API_KEY, AZURE_OPENAI_ENDPOINT, and OPENAI_API_VERSION (defaults to 2024-02-15-preview).
...
// .../openai/deployments/{deployment}/chat/completions so Azure can route
