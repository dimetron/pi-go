...
func TestBundledAgents_AllDefined(t *testing.T) {
	...
	// Should have exactly 14 bundled agents
	expected := []string{"explore", "plan", "designer", "task", "quick-task", "worker", "code-reviewer", "spec-reviewer", "memory-compressor", "discovery", "claude", "gemini", "cursor", "copilot"}
