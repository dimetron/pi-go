// This file mirrors claudecode/claude_mock_test.go: both packages hold
// their own copy of absDir, contentBlockText, stopReasonText, findBinary,
// and stderrBuffer, so the tests necessarily duplicate. Extracting those
// helpers into a shared package would let a single test file cover all
// three ACP runners — tracked as follow-up.
package gemini
