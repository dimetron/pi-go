...
/** Auto-generated by VS Code for the "pi-go-secondary" view container. */
export const CHAT_CONTAINER_COMMAND = "workbench.view.extension.pi-go-secondary";
...
export function activate(context: vscode.ExtensionContext): void {
  ...
  context.subscriptions.push(
    ...
    // Not workbench.action.openView: that is the "Open View…" quick pick and
    // ignores its argument, so it popped the "view " picker on every session
    // click. This command also shadows VS Code's auto-generated
    // pi-go.chat.focus, so open the view's container instead — the
    // auto-generated workbench.view.extension.<container> command reveals the
    // secondary sidebar and focuses the chat view inside it.
    vscode.commands.registerCommand("pi-go.chat.focus", () =>
      vscode.commands.executeCommand(CHAT_CONTAINER_COMMAND),
    ),
